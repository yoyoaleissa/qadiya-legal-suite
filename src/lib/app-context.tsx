...
export const translations = {
  ...
  ar: {
    ...
    open_report_bot: "افتح مساعد تقارير الدعاوى",
    staff_portal: "بوابة الموظفين",
    report_bot: "مساعد تقارير الدعاوى",
    report_bot_desc:
      "يُدخل الموكّل رقم الدعوى ليحصل فوراً على تقرير مبسّط بحالتها بالعربية والإنجليزية.",
    enter_case: "يُرجى إدخال رقم الدعوى",
    ...
    no_deadline: "لا توجد مواعيد إجرائية سارية — الدعوى مغلقة.",
    days_remaining: "يوماً متبقياً",
    what_it_means: "ماذا يعني هذا لك",
    timeline: "الجدول الزمني للدعوى",
    ...
    not_found_title: "الدعوى غير موجودة",
    not_found_desc: "تعذّر العثور على دعوى بهذا الرقم. يُرجى التحقق والمحاولة مرة أخرى.",
    try_example: "جرّب الدعوى التجريبية رقم 222486500",
    dashboard: "لوحة التحكم",
    coming_soon: "قريباً",
    disclaimer: "هذا التقرير إرشاد إجرائي مُستخرج من سجلات الدعوى، ولا يُعدّ مشورة قانونية ولا حكماً قضائياً.",
    powered: "مدعوم بذكاء قضية OS",
    documents: "إنشاء المستندات",
    documents_desc:
      "أنشئ مستندات جاهزة للمحكمة بتعبئة تلقائية من بيانات الدعوى والموكّل — بالعربية أو الإنجليزية.",
