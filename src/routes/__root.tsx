...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Qadiya OS — Kuwait Legal Practice Management" },
      {
        name: "description",
        content:
      ...
      { name: "author", content: "Qadiya OS" },
      { property: "og:title", content: "Qadiya OS — Kuwait Legal Practice Management" },
      {
    ...
    links: [
      ...
      {
        rel: "stylesheet",
        href: "https://fonts.googleapis.com/css2?family=Fraunces:opsz,wght@9..144,500;9..144,600;9..144,700&family=Inter:wght@400;500;600;700&family=Noto+Naskh+Arabic:wght@400;500;600;700&display=swap",
      },
    ],
  }),
...
function RootComponent() {
  ...
  // Keep router + query cache in sync with the auth session. AppShell is
  // rendered by the _authenticated layout, so public routes (login) render
  // bare here.
  useEffect(() => {
